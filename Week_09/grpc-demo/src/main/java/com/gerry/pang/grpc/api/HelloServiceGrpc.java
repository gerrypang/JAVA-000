...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.gerry.pang.grpc.api.HelloRequest,
      com.gerry.pang.grpc.api.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.gerry.pang.grpc.api.HelloRequest.class,
      responseType = com.gerry.pang.grpc.api.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.gerry.pang.grpc.api.HelloRequest,
      com.gerry.pang.grpc.api.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.gerry.pang.grpc.api.HelloRequest, com.gerry.pang.grpc.api.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.gerry.pang.grpc.api.HelloRequest, com.gerry.pang.grpc.api.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gerry.pang.grpc.api.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gerry.pang.grpc.api.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.gerry.pang.grpc.api.HelloRequest> sayHello(
        io.grpc.stub.StreamObserver<com.gerry.pang.grpc.api.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.gerry.pang.grpc.api.HelloRequest,
                com.gerry.pang.grpc.api.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gerry.pang.grpc.api.HelloWorldProto.getDescriptor();
    }
