...
public class NettyServer {
	...
	public Channel start(RpcfxResolver resolver) throws Exception {
        ...
        RestChannelInitializer restChannelInitializer = new RestChannelInitializer(NettySocketEnum.SERVER, resolver);
        serverBootstrap.childHandler(restChannelInitializer); 
